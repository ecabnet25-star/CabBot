...
from PyQt5.QtWidgets import (
    QApplication, QWidget, QVBoxLayout, QPushButton, QTextEdit, QCheckBox, QLabel, QDateTimeEdit, QHBoxLayout, QListWidget
)
...
class SocialMediaBotApp(QWidget):
    ...
    def init_ui(self):
        ...
        # Connection status labels and connect buttons
        from os.path import exists, dirname, join
        self.x_status = QLabel()
        self.reddit_status = QLabel()
        self.telegram_status = QLabel()
